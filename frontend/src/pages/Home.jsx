...
const HeroSection = lazy(
  () => import("../components/HeroSectionComp/HeroSection"),
);
  ...
  return (
    <>
      <Helmet>
        <meta
          name="description"
          content="Projex helps teams manage projects efficiently, collaborate in real-time, and leverage AI for forecasting."
        />

        <meta
          name="keywords"
          content="Projex, Project Management, AI, Team Collaboration, Pricing"
        />
        ...
        <meta
          property="og:title"
          content="Projex - Project Management Made Easy"
        />

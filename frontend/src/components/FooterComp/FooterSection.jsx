  ...
  return (
    <footer className="bg-gradient-to-t from-primary to-secondary text-text-footer py-16">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Projex, project management, contact, social media, footer"
        />
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-card-text/80">
              Projex helps teams manage projects efficiently, collaborate in
              real-time, and leverage AI for forecasting. Our mission is to
        ...
        <div className="border-t border-card-text/10 mt-16 pt-6 text-center">
          <p className="text-sm text-card-text/80">
            © 2025 Projex. All rights reserved. |{" "}

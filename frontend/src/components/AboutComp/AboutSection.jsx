    ...
    () => [
      {
        title: "Our Vision",
        description:
          "To make project management effortless and intelligent, empowering teams with AI tools for success.",
      },
      {
        title: "What Sets Us Apart",
        description:
          "We integrate AI-driven insights, automate repetitive tasks, and scale solutions for all team sizes.",
      },
      {
        title: "AI Insights",
        description:
          "Unlock smarter decision-making with AI-generated analytics.",
      },
      {
        title: "Scalable",
        description:
          "Flexible solutions for teams of any size, from solo projects to enterprises.",
      },
      {
        title: "User-Friendly",
        description:
          "Intuitive design ensures seamless navigation and productivity.",
      },
    ],
    ...
    <section className="bg-background py-20 relative mt-[-85px]">
      ...
      <Suspense fallback={null}>
        <Helmet>
          ...
          <meta
            name="keywords"
            content="about, Projex, project management, enterprise, team collaboration"
          />
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-4xl font-extrabold text-text-heading mb-8">
          About Projex
        </h2>
        <p className="text-xl text-card-text/80 mb-16 max-w-2xl mx-auto">
          Projex simplifies team collaboration with AI-powered tools, enhancing
        ...
        <div className="mt-16">
          <h3 className="text-3xl font-semibold text-text-heading mb-10">
            Why Choose Projex?
          </h3>

...
const pricingTiers = [
  ...
  },
  {
    title: 'Startup Plan',
    price: '$19.99/month',
    description: 'Designed for startups with advanced features and integrations.',
  ...
  },
  {
    ...
    price: '$39.99/month',
    description: 'Tailored for large teams with professional-level solutions and automation.',
...
const PricingCard = ({ tier }) => (
  ...
  >
    ...
    <h3 className="text-card-text text-xl md:text-2xl font-semibold mb-2">{tier.title}</h3>
